...
/*                                                                                      */
/*   This is version 1.40 of September 18, 2017 by Joergen Arendt Jensen                */
/*                                                                                      */
/*--------------------------------------------------------------------------------------*/
...
/*  Ver. 1.40, 18/09-17,  JAJ: Dimension array changed to be compatible with Matlab 2017*/
/*======================================================================================*/
...
{int main_code;    /*  Code for the module called   */
  ...
  mwSize           dimension[2];    /*  Dimension of the resulting array                         */
